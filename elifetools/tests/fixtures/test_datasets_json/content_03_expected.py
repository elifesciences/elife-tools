            ...
            [
                OrderedDict(
                    [
                        ...
                        (
                            "details",
                            u"Publicly available at NCBI (Accession no: KR021366)",
                        ),
                        ("uri", u"https://www.ncbi.nlm.nih.gov/nuccore/976151098/"),
                        ("date", u"2016"),
                        (
                            "title",
                ...
                OrderedDict(
                    [
                        ...
                        (
                            "details",
                            u"Publicly available at NCBI (Accession no: KR021365)",
                        ),
                        ("uri", u"https://www.ncbi.nlm.nih.gov/nuccore/976151096/"),
                        ("date", u"2015"),
                        (
                            "title",
                            u"An effector of the Irish potato famine pathogen antagonizes a host autophagy cargo receptor",
                ...
                OrderedDict(
                    [
                        ...
                        (
                            "title",
                            u"PREDICTED: Solanum tuberosum protein NBR1 homolog (LOC102582603), transcript variant X2, mRNA",
                        ),
                        (
                            "details",
                            u"Publicly available at NCBI nucleotide (Accession no: XM_006344410.2)",
                        ),
                        ("uri", u"http://www.ncbi.nlm.nih."),
                        (
                            "authors",
                            [
                                {"type": "group", "name": "Dagdas YF"},
