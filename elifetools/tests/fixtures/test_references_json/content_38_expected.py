...
expected = [
    OrderedDict([
        ...
        ('articleTitle', u'A prospective randomized trial examining health care utilization in individuals using multiple smartphone-enabled biosensors'),
        ('source', u'bioRxiv'),
        ('doi', u'10.1101/029983'),
