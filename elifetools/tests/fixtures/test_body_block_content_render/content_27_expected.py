                                    ...
                                    [
                                        OrderedDict(
                                            [
                                                ...
                                                (
                                                    "text",
                                                    u"At least 4 unique reads supporting variants and all variant reads at least 20 phred scale sequencing quality score (Q 20 = 1% sequencing error rate) and at least 3% variant allele fractions (VAFs).",
                                                ),
                                            ]
                                        ),
                                        OrderedDict(
                                                        ...
                                                        [
                                                            OrderedDict(
                                                                [
                                                                    ...
                                                                    (
                                                                        "text",
                                                                        u"A. Regardless of in WGS and in WES, the \u22654 mismatches and the \u22653% VAF criteria must be satisfied simultaneously.",
                                                                    ),
                                                                ]
                                                            )
                                                        ],
                                                        [
                                                            OrderedDict(
                                                                [
                                                                    ...
                                                                    (
                                                                        "text",
                                                                        u"B. However, in WGS, the minimum number of reads (n = 4) criterion is not essential, because the \u22653% VAF criterion is much more stringent (3% VAF request at least 240 mismatches (&gt;&gt;4) given mtDNA coverage is \u223c8000 for WGS).",
                                                                    ),
                                                                ]
                                                            )
                                                        ],
