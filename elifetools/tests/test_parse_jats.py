...
class TestParseJats(unittest.TestCase):
    ...
    @data(
        ...
        ('<root xmlns:xlink="http://www.w3.org/1999/xlink"><ref-list><ref id="bib101"><element-citation publication-type="book"><person-group person-group-type="author"><name><surname>Wood</surname><given-names>WB</given-names></name><collab>The Community of <italic>C. elegans</italic>Researchers</collab></person-group><year>1988</year><source>The nematode Caenorhabditis elegans</source><publisher-loc>Cold Spring Harbor, New York</publisher-loc><publisher-name>Cold Spring Harbor Laboratory Press</publisher-name></element-citation></ref></ref-list></root>',
         [OrderedDict([('type', u'book'), ('id', u'bib101'), ('date', u'1988'), ('authors', [OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'WB Wood'), ('index', u'Wood, WB')]))]), OrderedDict([('type', 'group'), ('name', u'The Community of <i>C. elegans</i>Researchers')])]), ('authorsType', 'authors'), ('bookTitle', u'The nematode Caenorhabditis elegans'), ('publisher', OrderedDict([('name', [u'Cold Spring Harbor Laboratory Press']), ('address', OrderedDict([('formatted', [u'Cold Spring Harbor, New York']), ('components', OrderedDict([('locality', [u'Cold Spring Harbor, New York'])]))]))]))])]
         ),
        ...
        [OrderedDict([('type', u'book'), ('id', u'bib18'), ('date', u'2013'), ('authors', [OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'YC Fung'), ('index', u'Fung, YC')]))])]), ('authorsType', 'authors'), ('bookTitle', u'Biomechanics: Mechanical Properties of Living Tissues'), ('publisher', OrderedDict([('name', [u'Springer Science & Business Media']), ('address', OrderedDict([('formatted', [u'New York']), ('components', OrderedDict([('locality', [u'New York'])]))]))])), ('isbn', u'978-1-4757-2257-4')])]
         ),
        ...
        [OrderedDict([('type', u'book'), ('id', u'bib10'), ('date', u'1998'), ('authors', [OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'J Ekstrom'), ('index', u'Ekstrom, J')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'J. R Garrett'), ('index', u'Garrett, J. R')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'L. C Anderson'), ('index', u'Anderson, L. C')]))])]), ('authorsType', 'editors'), ('bookTitle', u'Glandular Mechanisms of Salivary Secretion (Frontiers of Oral Biology , Vol. 10)'), ('publisher', OrderedDict([('name', [u'S Karger']), ('address', OrderedDict([('formatted', [u'Basel']), ('components', OrderedDict([('locality', [u'Basel'])]))]))])), ('edition', u'1st edn'), ('isbn', u'978-3805566308')])]
        ),
