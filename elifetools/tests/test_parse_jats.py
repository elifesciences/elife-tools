...
class TestParseJats(unittest.TestCase):
    ...
    @data(
        ...
        [OrderedDict([('type', u'web'), ('id', u'bib1'), ('title', u'Fraxinus version1 data analysis'), ('uri', u'https://github.com/shyamrallapalli/fraxinus_version1_data_analysis'), ('date', '2013'), ('authors', [OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', 'Ghanasyam Rallapalli'), ('index', 'Rallapalli, Ghanasyam')]))])])]), OrderedDict([('type', u'web'), ('id', u'bib2'), ('title', u'Google api ruby client samples'), ('uri', u'https://github.com/google/google-api-ruby-client-samples/tree/master/service_account'), ('date', '2014'), ('authors', [OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', 'Steven Bazyl'), ('index', 'Bazyl, Steven')]))])])])]
         ),
