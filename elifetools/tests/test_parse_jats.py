...
class TestParseJats(unittest.TestCase):
    ...
    @data(
        ...
        ('<root xmlns:xlink="http://www.w3.org/1999/xlink"><back><app-group><app><title>Appendix 5</title><boxed-text><sec id="s56" sec-type="appendix"><sec id="s61"><title>E. Volatiles</title><p>Paragraph content.</p><table-wrap id="A5-tbl2" position="float"><object-id pub-id-type="doi">10.7554/eLife.17092.035</object-id><label>Appendix 5—table 2.</label><caption><p>Crushed eggshell sulfur-containing VOC emissions from 2.7 Ma OES (Laetoli LOT 13901). NA = no structural isomer can be determined.</p><p><bold>DOI:</bold><ext-link ext-link-type="doi" xlink:href="10.7554/eLife.17092.035">http://dx.doi.org/10.7554/eLife.17092.035</ext-link></p></caption><table frame="hsides" rules="groups"><tbody><tr><td valign="top"><inline-graphic mime-subtype="x-tiff" mimetype="image" xlink:href="elife-17092-inf1-v1"/><break/><inline-graphic mime-subtype="x-tiff" mimetype="image" xlink:href="elife-17092-inf2-v1"/></td></tr></tbody></table></table-wrap></sec></sec></boxed-text></app></app-group></back></root>',
         None,
         [OrderedDict([('title', u'Appendix 5'), ('content', [OrderedDict([('type', 'section'), ('id', u's61'), ('title', u'E. Volatiles'), ('content', [OrderedDict([('type', 'paragraph'), ('text', u'Paragraph content.')]), OrderedDict([('type', 'table'), ('doi', u'10.7554/eLife.17092.035'), ('id', u'A5-tbl2'), ('label', u'Appendix 5\u2014table 2.'), ('title', u'Crushed eggshell sulfur-containing VOC emissions from 2.7 Ma OES (Laetoli LOT 13901). NA = no structural isomer can be determined.'), ('caption', [OrderedDict([('type', 'paragraph'), ('text', u'Crushed eggshell sulfur-containing VOC emissions from 2.7 Ma OES (Laetoli LOT 13901). NA = no structural isomer can be determined.')])]), ('tables', ['<table><tbody><tr><td valign="top"><img src="elife-17092-inf1-v1.jpg"/><br/><img src="elife-17092-inf2-v1.jpg"/></td></tr></tbody></table>'])])])])])])]
        ),
    ...
    @data(
        ...
        [OrderedDict([('type', u'periodical'), ('id', u'bib40'), ('date', u'1993'), ('authors', [OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'J Schwartz'), ('index', u'Schwartz, J')]))])]), ('articleTitle', u'Obesity affects economic, social status'), ('periodical', OrderedDict([('name', [u'The Washington Post'])])), ('pages', OrderedDict([('first', u'A1'), ('last', u'A4'), ('range', u'A1\u2013A4')]))])]
         ),

         # 00666 kitchen sink example with a version tag
        ('<root xmlns:xlink="http://www.w3.org/1999/xlink"><ref-list><ref id="bib2"><element-citation publication-type="software"><person-group person-group-type="author"><name><surname>Bates</surname><given-names>D</given-names></name><name><surname>Maechler</surname><given-names>M</given-names></name><name><surname>Bolker</surname><given-names>B</given-names></name><name><surname>Walker</surname><given-names>S</given-names></name><name><surname>Haubo Bojesen Christensen</surname><given-names>R</given-names></name><name><surname>Singmann</surname><given-names>H</given-names></name><name><surname>Dai</surname><given-names>B</given-names></name><name><surname>Grothendieck</surname><given-names>G</given-names></name><name><surname>Green</surname><given-names>P</given-names></name></person-group><person-group person-group-type="curator"><name><surname>Bolker</surname><given-names>B</given-names></name></person-group><year iso-8601-date="2016">2016</year><data-title>Lme4: Linear Mixed-Effects Models Using Eigen and S4</data-title><source>CRAN</source><ext-link ext-link-type="uri" xlink:href="https://cran.r-project.org/web/packages/lme4/index.html">https://cran.r-project.org/web/packages/lme4/index.html</ext-link><!-- designator attribute added for version - Feb 8 2017 --><version designator="1.1-12">1.1-12</version></element-citation></ref>',
        [OrderedDict([('type', u'software'), ('id', u'bib2'), ('date', u'2016'), ('authors', [OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'D Bates'), ('index', u'Bates, D')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'M Maechler'), ('index', u'Maechler, M')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'B Bolker'), ('index', u'Bolker, B')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'S Walker'), ('index', u'Walker, S')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'R Haubo Bojesen Christensen'), ('index', u'Haubo Bojesen Christensen, R')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'H Singmann'), ('index', u'Singmann, H')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'B Dai'), ('index', u'Dai, B')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'G Grothendieck'), ('index', u'Grothendieck, G')]))]), OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'P Green'), ('index', u'Green, P')]))])]), ('title', u'Lme4: Linear Mixed-Effects Models Using Eigen and S4'), ('source', u'CRAN'), ('publisher', OrderedDict([('name', [u'CRAN'])])), ('version', u'1.1-12'), ('uri', u'https://cran.r-project.org/web/packages/lme4/index.html')])]
        ),
