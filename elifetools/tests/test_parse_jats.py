...
class TestParseJats(unittest.TestCase):
    ...
    @data(
        ...
        [OrderedDict([('mediaType', 'application/zip'), ('uri', u'elife-16996-supp-v1.zip'), ('filename', u'elife-16996-supp-v1.zip')])]
         ),
        ...
        [OrderedDict([('mediaType', 'application/zip'), ('uri', u'elife-02184-supp-v1.zip'), ('filename', u'elife-02184-supp-v1.zip')])]
         ),
        ...
        [OrderedDict([('mediaType', 'application/zip'), ('uri', u'elife-04493-supp-v1.zip'), ('filename', u'elife-04493-supp-v1.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_2.zip'), ('filename', u'Video_2.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_8.zip'), ('filename', u'Video_8.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_6.zip'), ('filename', u'Video_6.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_11.zip'), ('filename', u'Video_11.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_17.zip'), ('filename', u'Video_17.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_18.zip'), ('filename', u'Video_18.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_7.zip'), ('filename', u'Video_7.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_10.zip'), ('filename', u'Video_10.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_5.zip'), ('filename', u'Video_5.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_13.zip'), ('filename', u'Video_13.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_19.zip'), ('filename', u'Video_19.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_15.zip'), ('filename', u'Video_15.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_21.zip'), ('filename', u'Video_21.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_22.zip'), ('filename', u'Video_22.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_4.zip'), ('filename', u'Video_4.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_20.zip'), ('filename', u'Video_20.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_12.zip'), ('filename', u'Video_12.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_1.zip'), ('filename', u'Video_1.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_16.zip'), ('filename', u'Video_16.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_3.zip'), ('filename', u'Video_3.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_9.zip'), ('filename', u'Video_9.zip')]), OrderedDict([('mediaType', 'application/zip'), ('uri', u'Video_14.zip'), ('filename', u'Video_14.zip')])]
         ),
    ...
    @data(
        ...
        ('<root xmlns:xlink="http://www.w3.org/1999/xlink"><article><journal-meta><journal-id journal-id-type="hwp">elife</journal-id></journal-meta><article-meta><article-id pub-id-type="publisher-id">05519</article-id><article-id pub-id-type="doi">10.7554/eLife.05519</article-id></article-meta><body><sec id="s4"><title>Keep this section</title><sec><sec id="s4-1-1"><title>Keep this inner section</title><p>Content</p></sec><sec id="s4-1-2"><title>Keep this section too</title><p>More content</p></sec></sec></sec></body></article></root>',
    ...
    @data(
        ...
        ('<root xmlns:xlink="http://www.w3.org/1999/xlink"><article><journal-meta><journal-id journal-id-type="hwp">elife</journal-id></journal-meta><article-meta><article-id pub-id-type="publisher-id">00051</article-id><article-id pub-id-type="doi">10.7554/eLife.00051</article-id></article-meta><ref-list><ref id="bib25"><element-citation publication-type="web"><person-group person-group-type="author"><name><surname>Jha</surname><given-names>P</given-names></name><name><surname>Nugent</surname><given-names>R</given-names></name><name><surname>Verguet</surname><given-names>S</given-names></name><name><surname>Bloom</surname><given-names>D</given-names></name><name><surname>Hum</surname><given-names>R</given-names></name></person-group><article-title>Chronic Disease Prevention and Control. Copenhagen Consensus 2012 Challenge Paper</article-title><ext-link ext-link-type="uri" xlink:href="http://www.copenhagenconsensus.com/files/Filer/CC12%20papers/Chronic%20Disease.pdf">http://www.copenhagenconsensus.com/files/Filer/CC12%20papers/Chronic%20Disease.pdf</ext-link></element-citation></ref></ref-list></article></root>',
        ...
        [OrderedDict([('type', u'journal'), ('id', u'bib6'), ('date', u'2015'), ('authors', [OrderedDict([('type', 'person'), ('name', OrderedDict([('preferred', u'J Berni'), ('index', u'Berni, J')]))])]), ('articleTitle', u'Genetic dissection of a regionally differentiated network for exploratory behavior in Drosophila larvae'), ('journal', OrderedDict([('name', [u'Current Biology'])])), ('volume', u'25'), ('pages', OrderedDict([('first', u'1319'), ('last', u'1326'), ('range', u'1319\u20131326')])), ('doi', u'10.1016/j.cub.2015.03.023'), ('pmid', 25959962)])]
         ),
        ...
        ('<root xmlns:xlink="http://www.w3.org/1999/xlink"><article><journal-meta><journal-id journal-id-type="hwp">elife</journal-id></journal-meta><article-meta><article-id pub-id-type="publisher-id">07460</article-id><article-id pub-id-type="doi">10.7554/eLife.07460</article-id></article-meta><ref-list><ref id="bib1"><element-citation publication-type="web"><article-title>Fraxinus version1 data analysis</article-title><comment>URL: <ext-link ext-link-type="uri" xlink:href="https://github.com/shyamrallapalli/fraxinus_version1_data_analysis">https://github.com/shyamrallapalli/fraxinus_version1_data_analysis</ext-link></comment></element-citation></ref><ref id="bib2"><element-citation publication-type="web"><article-title>Google api ruby client samples</article-title><comment>URL: <ext-link ext-link-type="uri" xlink:href="https://github.com/google/google-api-ruby-client-samples/tree/master/service_account">https://github.com/google/google-api-ruby-client-samples/tree/master/service_account</ext-link></comment></element-citation></ref></ref-list></article></root>',
        ...
        ('<root xmlns:xlink="http://www.w3.org/1999/xlink"><article><journal-meta><journal-id journal-id-type="hwp">elife</journal-id></journal-meta><article-meta><article-id pub-id-type="publisher-id">20522</article-id><article-id pub-id-type="doi">10.7554/eLife.20522</article-id></article-meta><ref-list><ref id="bib42"><element-citation publication-type="journal"><person-group person-group-type="author"><name><surname>Ellegren</surname><given-names>H</given-names></name><name><surname>Galtier</surname><given-names>N</given-names></name></person-group><year iso-8601-date=" 2016"> 2016</year><article-title>Self fertilization and population variability in the higher plants (vol 91, pg 41, 1957)</article-title><source>Nature Reviews Genetics</source><volume>17</volume><fpage>422</fpage><lpage>433</lpage><pub-id pub-id-type="doi">10.1038/nrg.2016.58</pub-id></element-citation></ref></ref-list></article></root>',
