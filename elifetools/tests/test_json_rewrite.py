...
class TestJsonRewrite(unittest.TestCase):
    ...
    @data(
        ...
        ({'generated': [{'id': 'dataro1', 'date': '2014-2015'}]}, '10.7554/eLife.04660'),
        ({'used': [{'id': 'dataro2', 'date': 'NA'}]}, '10.7554/eLife.06421'),
        ({'used': [{'id': 'data-ro1'}]}, '10.7554/eLife.08445'),
        ({'used': [{'id': 'dataro2', 'date': '2008, updated 2014'}]}, '10.7554/eLife.08916'),
        ({'used': [{'id': 'dataro3', 'date': '2013, updated 2014'}]}, '10.7554/eLife.08916'),
