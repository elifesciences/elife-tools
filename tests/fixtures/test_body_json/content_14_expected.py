            ...
            (
                ...
                [
                    ...
                    OrderedDict(
                        [
                            ("type", "box"),
                            ("doi", u"10.7554/eLife.23383.002"),
                            ("id", u"B1"),
                            ("label", u"Box 1"),
                            (
                                "title",
                                u"The first results from the Reproducibility Project: Cancer Biology",
                            ),
                            (
                                "content",
                                [
